...
> **For Claude:** REQUIRED SKILL: Use
> `look-before-you-leap:engineering-discipline` for all steps. Also invoke each
...
skill identifiers for Claude. Format:
...
at once. Ownership and resume selection are handled by Claude runtime metadata,
...
|---|---|---|
| Audience | Claude + hooks | User / reviewer |
