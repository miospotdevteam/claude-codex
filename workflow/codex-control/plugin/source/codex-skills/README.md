...
The repo installer installs this Codex-native pack and the shared Claude skills
under
`workflow/claude-control/plugin/source/look-before-you-leap/skills/`,
except Claude `frontend-design`. That source stays in the monorepo
for sync, but installed Codex sessions use `lbyl-frontend-design` as the
single standard frontend design skill.
...
cp -R ../../../claude-control/plugin/source/look-before-you-leap/skills/* ~/.codex/skills/
