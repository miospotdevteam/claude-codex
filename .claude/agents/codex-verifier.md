<!-- Compatibility mirror. Canonical source: orchestration/agents/codex-verifier.md -->
---
name: codex-verifier
description: >
...
2. The canonical implementation lives at `orchestration/scripts/codex-verifier.sh --requirements-file <path>`.
3. The root `scripts/codex-verifier.sh` path is a compatibility wrapper and may still be used from the repo root.
4. Return a clear verdict:
   - `VERDICT: PASS`
   - `VERDICT: FAIL`
5. List concrete issues with file paths when failures are found.
